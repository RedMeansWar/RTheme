...
namespace RTheme
{
    ...
    public class RPassTextBox : Control
    {
        ...
        public RPassTextBox()
        {
            __ENCAddToList(this);
            State = DrawHelper.MouseState.None;
            _BaseColour = Color.FromArgb(255, 255, 255);
            _TextColour = Color.FromArgb(50, 50, 50);
            _BorderColour = Color.FromArgb(180, 187, 205);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            SolidBrush brush = new SolidBrush(FindForm().BackColor);
            checked
            {
                Rectangle rect = new Rectangle(Width - 25, Height - 60, Height + 25, Height + 25);
                graphics3.FillPie(brush, rect, 90f, 90f);
                Graphics graphics4 = graphics2;
                Pen pen = new Pen(Color.FromArgb(35, 35, 35), 2f);
                rect = new Rectangle(Width - 25, Height - 60, Height + 25, Height + 25);
                graphics4.DrawPie(pen, rect, 90f, 90f);
                Graphics graphics5 = graphics2;
                SolidBrush brush2 = new SolidBrush(_TextColour);
                rect = new Rectangle(10, 5, 10, 7);
                graphics5.FillEllipse(brush2, rect);
