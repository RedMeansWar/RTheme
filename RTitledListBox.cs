...
namespace RTheme
{
    internal class RTitledListBox : Control
    {
        ...
        public RTitledListBox()
        {
            ...
            _TitleFont = new Font("Segeo UI", 10f, FontStyle.Bold);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                Size size = new Size(Width - 6, Height - 30);
                listB.Size = size;
                ...
                Point pt = new Point(0, 27);
                Point pt2 = new Point(Width - 1, 27);
                graphics4.DrawLine(pen2, pt, pt2);
                Graphics graphics5 = graphics2;
                string s = Text;
                Font titleFont = _TitleFont;
                SolidBrush brush = new SolidBrush(_TextColour);
                rect2 = new Rectangle(2, 5, Width - 5, 20);
                graphics5.DrawString(s, titleFont, brush, rect2, new StringFormat
                {
