...
namespace RTheme
{
    ...
    public class RUserTextBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                Rectangle rect = new Rectangle(Width - 25, Height - 23, Height + 25, Height + 25);
                graphics3.FillPie(brush, rect, 180f, 90f);
                Graphics graphics4 = graphics2;
                Pen pen = new Pen(Color.FromArgb(35, 35, 35), 2f);
                rect = new Rectangle(Width - 25, Height - 23, Height + 25, Height + 25);
                graphics4.DrawPie(pen, rect, 180f, 90f);
